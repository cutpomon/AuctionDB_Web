...
namespace EFCoreFirstDB.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ItemItemProperty",
                columns: table => new
                {
                    ItemPropertiesId = table.Column<int>(type: "int", nullable: false),
                    ItemsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemItemProperty", x => new { x.ItemPropertiesId, x.ItemsId });
                    table.ForeignKey(
                        name: "FK_ItemItemProperty_ItemProperties_ItemPropertiesId",
                        column: x => x.ItemPropertiesId,
                        principalTable: "ItemProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemItemProperty_Items_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemItemProperty_ItemsId",
                table: "ItemItemProperty",
                column: "ItemsId");
